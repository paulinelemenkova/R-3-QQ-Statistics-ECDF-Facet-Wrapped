...
# ЧАСТЬ 3: делаем QQ статистику (по квантилям), рисуем график. Для множества из 25 профилей.
	# шаг-4. Рисуем на одном графике квантили всех 25 профилей + линию средних значений.
p<- qplot(data = MarDF_NEW, sample = value, color = profiles) +
